...
// Required fields
$requiredFields = ['fullName', 'email', 'phone', 'address', 'reviews'];
...
$message = cleanInput($_POST['reviews']);
...
$postData = [
    ...
    'subject' => 'New Review from Website || 5 Star Iron Fabrications LLC',
    'content' => $emailBody,
